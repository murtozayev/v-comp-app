...
const Footer = () => {
    return (
        <footer className=" text-[white] px-[10vw] py-[2vw] h-[30vw] bg-[#090937] ">
            <div className="flex items-start justify-between ">
                ...
                <div>
                    ...
                    <form className=" flex flex-col gap-[1vw] ">
                        ...
                        <div>
                            <input type="text" className=" text-[black] font-semibold text-[1vw] p-[0.5vw] outline-none rounded-[0.2vw] pr-[4vw] " placeholder="Please enter your email..." />
            ...
            <div className=" flex items-center gap-[3vw] py-[1vw] border-t border-b mt-[5vw] ">
