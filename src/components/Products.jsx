...
const Products = () => {
    ...
    return (
        <div className=" mt-[5vw] px-[10vw] ">

            <h1 className=" font-semibold text-[2vw]  ">Top Products</h1>
            ...
            {loading ? <FadeLoader className="w-[20vw] mx-auto mt-[20vw] " /> : (
                <>
                    ...
                    <button onClick={() => navigate("/store")} className=" bg-[red] text-white flex float-right mt-[2vw] items-center gap-[2vw] px-[3vw] py-[0.6vw] rounded-[1vw] ">
                        <span>Shop now</span>
